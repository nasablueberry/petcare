...
import { Heart, Shield, Clock, Award, Snowflake, ThermometerSnowflake, ArrowRight } from 'lucide-react';
        ...
        >
          <SwiperSlide>
            <div className="relative h-full">
              <img
                src="https://images.unsplash.com/photo-1634003311973-73877ca84d48?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkb2clMjB3aW50ZXIlMjBjb2F0JTIwc25vd3xlbnwxfHx8fDE3NjQzMjU4NTR8MA&ixlib=rb-4.1.0&q=80&w=1080"
          ...
          <SwiperSlide>
            <div className="relative h-full">
              <img
                src="https://images.unsplash.com/photo-1642906376920-cf2dfbd287bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXQlMjBncm9vbWluZyUyMHdpbnRlcnxlbnwxfHx8fDE3NjQzMjU4NTV8MA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Pet grooming"
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          ...
          <SwiperSlide>
            <div className="relative h-full">
              <img
                src="https://images.unsplash.com/photo-1611632819596-c82fdecc0fc4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXQlMjBjb3p5JTIwd2ludGVyfGVufDF8fHx8MTc2NDMyNTg1NHww&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Happy pet"
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
